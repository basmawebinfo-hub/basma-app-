...
export const translations: Record<string, { ar: string; en: string }> = {
  ...
  // Hero
  "hero.badge": { ar: "منصة أتمتة الأعمال المدعومة بـ AI", en: "AI-powered business automation platform" },
  "hero.title": { ar: "أتمتة الاتصالات والعمليات", en: "Automate communications and operations" },
  "hero.subtitle": { ar: "ركّز على نموّ أعمالك. دع BASMA AI تدير الباقي.", en: "Focus on what matters. Let BASMA AI handle the rest." },
  "hero.cta": { ar: "ابدأ مجاناً", en: "Start Free" },
  "hero.title1": { ar: "أتمتة الأعمال", en: "Business automation" },
  "hero.title2": { ar: "مصممة للثقة.", en: "built for trust." },
  "hero.desc": { ar: "اربط WhatsApp مع أنظمتك. أتمت الاتصالات. حسّن الكفاءة. مع الأمان والخصوصية في القلب.", en: "Connect WhatsApp with your systems. Automate communications. Improve efficiency. With security and privacy at the core." },
  ...
  "forgot.send": { ar: "إرسا�� رابط ��لتعيين", en: "Send reset link" },
  ...
  "dp.feat4": { ar: "صن��وق وارد وتحليلات", en: "Inbox & analytics" },
  ...
  "set.useKeyN8n": { ar: "استخدم هذا المفتاح في n8n لإرسال الرسائل ع��ر", en: "Use this key in n8n to send messages via" },
  ...
  "usage.numbers":      { ar: "الأ��ق��م النشطة",  en: "Active numbers" },
