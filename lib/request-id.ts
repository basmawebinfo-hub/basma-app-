...
//
// Every log line should carry a request_id that ties together all activity
// for a single HTTP request. This lets us search Vercel Logs by the same ID
// and see the full request timeline.
//
// Strategy:
 ...
 * subsequent logger.* calls for that request.
 */
