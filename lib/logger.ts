...
// Sentry Log Drains, and downstream tools can parse it directly.
//
...
/**
 * Sensitive header names we always strip if they somehow end up in a log
 * fields object. Defence-in-depth alongside Sentry beforeSend.
 */
