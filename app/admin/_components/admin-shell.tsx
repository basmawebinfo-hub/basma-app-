...
import {
  LayoutDashboard, Users, Server, Wallet, ScrollText, ShieldCheck,
  LogOut, MessageCircle, CreditCard,
} from "lucide-react"
      ...
      <aside className="w-60 border-e border-border bg-card/40 flex flex-col shrink-0">
        ...
        <div className="p-3 border-t border-border">
          <form action={logout}>
            <button
              type="submit"
              className="w-full flex items-center gap-2 px-3 py-2 text-sm text-red-600 hover:bg-red-500/10 rounded-lg"
            >
